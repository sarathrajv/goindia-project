  ...
  return (
    <div>
        <div className="navbarmaindiv">
            <h5 className='secondnavbarfonts' >.50</h5>
            <h5 className='secondnavbarfontsred' >0.21%</h5>
            <h5 className='secondnavbarfonts' >NIFTYBANK</h5>
            <h5 className='secondnavbarfonts' >41599.40</h5>
            <h5 className='secondnavbarfontsgreen' >0.01%</h5>
            <h5 className='secondnavbarfonts' >BAJAJFINANCE</h5>
            <h5 className='secondnavbarfonts' >6,435.50</h5>
            <h5 className='secondnavbarfontsred' >0.30%</h5>
